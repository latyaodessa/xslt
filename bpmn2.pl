...
has_author(sample_bpmn_process_2,admin).
		 
has_total_count_objects(sample_bpmn_process_2,32).
		 
has_type(sample_bpmn_process_2,business_process_diagram__bpmn_2_0_).
